...
function NavBar() {
  return (
    <div className="grid grid-rows-12 z-10 fixed top-0 w-full">
    ...
    <div className="col-span-1">
      ...
      <div className="row-span-10 grid grid-cols-8 z-10">
        <div className="row-start-2 col-span-1 col-start-2">
        <H_option option={"Conditions A-Z"}/>
        </div>
        <div className="row-start-3 col-span-1 col-start-2">
        <H_option option={"Living Well"}/>
        </div>
        <div className="row-start-4 col-span-1 col-start-2">
        ...
        <div className="row-start-5 col-span-1 col-start-7">
